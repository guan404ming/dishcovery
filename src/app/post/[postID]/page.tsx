    ...
    <>
      ...
      <div className="flex gap-4">
        <div className="w-[40%] md:w-[40%] items-stretch">
          <div className="md:h-[230px] lg:h-[350px] w-full">
            <img src={post.image1} className="h-full w-full object-cover rounded-xl md:rounded-2xl lg:rounded-3xl"></img>
          </div>
        </div>
        <div className="hidden md:block w-[20%]">
          <div className="flex flex-col gap-4">
            <img src={post.image2} className="h-[108px] lg:h-[166px] object-cover rounded-lg md:rounded-xl lg:rounded-2xl"></img>
            <img src={post.image3} className="h-[108px] lg:h-[166px] object-cover  rounded-lg md:rounded-xl lg:rounded-2xl"></img>
          </div>
        </div>
