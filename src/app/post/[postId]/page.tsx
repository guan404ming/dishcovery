...
const dish = {
  ...
  quantity: 3,
  description:
    "123當是用新鮮食材製作的...當是用新鮮食材製作的...當是用新鮮食材製作的...當是用新鮮食材製作的...當是用新鮮食材製作的...123當是用新鮮食材製作的...當是用新鮮食材製作的...當是用新鮮食材製作的...當是用新鮮食材製作的...當是用新鮮食材製作的...123當是用新鮮食材製作的...當是用新鮮食材製作的...當是用新鮮食材製作的...當是用新鮮食材製作的...當是用新鮮食材製作的...",
};
