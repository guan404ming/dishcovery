...
export default function Product({image, image1, image2, productName, cost, remainAmount, comment}:postProps) {
  ...
  return (
    <>
      <div className="flex gap-4 items-center md:mx-8">
        <div className="w-[40%] md:w-[40%] items-stretch">
          <div className="h-full">
            <img src={image} className="h-full object-cover rounded-xl md:rounded-2xl lg:rounded-3xl"></img>
          </div>
        </div>
        <div className="h-[80%] hidden md:block w-[20%] mt-4 ">
          <div className="flex flex-col gap-4">
            <img src={image1} className="rounded-lg md:rounded-xl lg:rounded-2xl"></img>
            <img src={image2} className="rounded-lg md:rounded-xl lg:rounded-2xl"></img>
          </div>
        </div>
      ...
      <div className="flex md:hidden mt-4 mb-4">
        <div className="w-[40%] md:w-[60%]">
          <div className="flex mt-[-10px] md:mt-0 gap-2 md:gap-4">
            <img src={image1} className="w-[43%] rounded-lg md:rounded-xl lg:rounded-2xl"></img>
            <img src={image2} className="w-[43%] rounded-lg md:rounded-xl lg:rounded-2xl"></img>
          </div>
        </div>
